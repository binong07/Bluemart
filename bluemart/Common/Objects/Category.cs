...
namespace bluemart.Common.Objects
{
	...
	{
		public Category(string name, string categoryImagePath,bool isSubCategory = true, string categoryID = null, List<string> subCategories = null  )//public Category(string name, string categoryImageName,bool isSubCategory = true, string categoryID = null, List<string> subCategories = null  )
		{
			this.Name = name;
