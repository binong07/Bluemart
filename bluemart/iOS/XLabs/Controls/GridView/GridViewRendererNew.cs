...
[assembly: ExportRenderer (typeof(GridView2), typeof(GridViewRendererNew))]
namespace XLabs.Forms.Controls
{
	...
	/// <summary>
	/// Class GridViewRendererNew.
	/// </summary>
	public class GridViewRendererNew: ViewRenderer<GridView2,GridCollectionView>, IGridViewProvider
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="GridViewRendererNew"/> class.
		/// </summary>l
		...
		protected override void OnElementChanged (ElementChangedEventArgs<GridView2> e)
		{
		...
		protected override void OnElementPropertyChanged (object sender, System.ComponentModel.PropertyChangedEventArgs e)
		{
			...
			if (e.PropertyName == "ItemsSource") {
				var gridView = sender as GridView2;
		...
		private void Unbind (GridView2 oldElement)
		{
			if (oldElement != null) {
		...
		private void Bind (GridView2 newElement)
		{
			if (newElement != null) {
		...
		void HandleOnScrolled (CGPoint contentOffset)
		{
			...
			Element.RaiseOnScroll (0, (float)contentOffset.Y,0);
		}
